...
<div class="container-fluid flashcard-container">
    <div class="container">
        <h1>Flash Cards</h1>
        <div class="row">
            ...
            <div class="col-lg-4 col-6 mb-3">
                <div class="card text-white bg-orange mb-3 h-100" style="transition: all .2s ease-in-out; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); border: 1px solid rgba(0,0,0,0.125);" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title h3">{{ $course->name }} ({{ $course->flash_questions_count }})</h5>
                        <p class="card-text">{{ $course->description }}</p>
                        <a href="{{ route('flash.card', ['course_id' => $course->id]) }}" class="btn btn-sm btn-dark">View Flash Cards</a>
                    </div>
                </div>
            </div>
            @endforeach
