...
<h2 class="mb-4" style="text-align: center;">PgMP Test 1 Question & Answer</h2>
                ...
                <div class="modal-body addModalAnswers">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="hidden" class="w-100" id="subjectInput" name="subject" value="PgMP">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="hidden" class="w-100" id="testTitleInput" name="title" value="test 1">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="hidden" class="w-100" id="levelInput" name="label">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="hidden" class="w-100" id="explanationInput" name="explanation">
