...
<br><br>
<h2 class="mb-4" style="text-align: center;">PMP Test 6 Question & Answer</h2>
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <label for="Subject">Question<span style="color: red;">*</span></label>
                     <textarea name="question" class="w-100" placeholder="Enter your explaination(Optional)"></textarea>
