...
<br><br>
<h2 class="mb-4" style="text-align: center;">All Subjects Question & Answer</h2>
@if($questions->count() > 0)
<h3 class="mb-4">Label:- {{ $questions[0]->lavel }}</h3>
        ...
        <div class="modal-content">
            ...
            <form id="addQna">
                ...
                <div class="modal-body addModalAnswers">
                    <div class="row">
                        <div class="col">
                            <input type="hidden" class="form-control w-100" id="subjectInput" name="subject" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <input type="hidden" class="form-control w-100" id="testTitleInput" name="title" readonly>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="hidden" class="form-control w-100" id="levelInput" name="label" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">

                            <input type="hidden" class="form-control w-100" id="explanationInput" name="explanation" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label for="Subject">Question<span style="color: red;">*</span></label>
                            <input type="text" class="form-control w-100" name="question" placeholder="Enter Question" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label for="Subject">Q. Explanation(optional)</label>
                            <textarea name="explaination" rows="5" class="form-control w-100" placeholder="Enter your explaination(Optional)"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body editModalAnswers">
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control w-100" name="question" id="question" placeholder="Enter Question" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
                            <textarea name="explaination" id="explaination" rows="5" class="form-control w-100" placeholder="Enter your explaination(Optional)"></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <select name="" id="subject" class="form-control w-100">
            ...
            <div class="modal-body">
                ...
                <select name="" id="testTitle" class="form-control w-100">
            ...
            <div class="modal-body">
                ...
                <select name="lavel" class="form-control w-100" id="level" style="border-radius: 5px;">
            ...
            <div class="modal-body">
                ...
                <textarea name="" id="explanation" cols="30" rows="10" class="form-control w-100"></textarea>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    $(document).ready(function() {
            ...
            if ($(".answers").length >= 6) {
                ...
                var html = `
                    <div class="row mt-2 answers">
                        ...
                        <div class="col">
                            <input type="text" class="form-control w-100" name="answers[]" placeholder="Enter Enswer" required>
                        </div>
        ...
        $("#addEditAnswer").click(function() {
            if ($(".editAnswers").length >= 6) {
                ...
                var html = `
                        <div class="row mt-2 editAnswers px-3">
                            <input type="radio" name="is_correct" class="edit_is_correct">
                            <div class="col">
                                <input type="text" class="form-control w-100" name="new_answers[]" placeholder="Enter Answer" required>
                            </div>
                            <button class="btn btn-danger removeButton">Remove</button>
                        </div>
                    `;
                    ...
                    for (let i = 0; i < qna['answers'].length; i++) {
                        ...
                        html += `
                            <div class="row mt-2 editAnswers px-3">
                                ...
                                <div class="col">
                                    <input type="text" class="form-control w-100" name="answers[` + qna['answers'][i]['id'] + `]" 
